...
module ControlUnit(
    input [5:0] opcode,
    input [5:0] func,
    output reg JMP, JR, SignedExt, Beq, Bne, MemToReg, MemWrite, AluSrcB, RegWrite, JAL, RegDst, Syscall, LH, BLEZ, SRLV,
...
always @(opcode or func) begin
    case (opcode)
        ...
        // my
        6'b001011:begin // 11; sltiu
            JMP = 0; JR = 0; SignedExt = 1;   Beq = 0; Bne = 0; MemToReg = 0;
            MemWrite = 0; AluSrcB = 1; RegWrite = 1; JAL = 0; RegDst = 0; Syscall = 0;
            LH = 0; BLEZ = 0; SRLV = 0;
            AluOP = 4'b1100;
        end
        6'b100001:begin // 33; lh
            JMP = 0; JR = 0; SignedExt = 1;   Beq = 0; Bne = 0; MemToReg = 1;
            MemWrite = 0; AluSrcB = 1; RegWrite = 1; JAL = 0; RegDst = 0; Syscall = 0;
            LH = 1; BLEZ = 0; SRLV = 0;
            AluOP = 4'b0101;
        end
        6'b000110:begin // 6; blez
            JMP = 0; JR = 0; SignedExt = 0;   Beq = 0; Bne = 0; MemToReg = 0;
            MemWrite = 0; AluSrcB = 0; RegWrite = 0; JAL = 0; RegDst = 0; Syscall = 0;
            LH = 0; BLEZ = 1; SRLV = 0;
            AluOP = 4'b0101;
