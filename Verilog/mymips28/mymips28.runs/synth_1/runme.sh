...
HD_PWD='D:/Study/Verilog/ComputerDesign/mymips28/mymips28.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MipsCPU_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MipsCPU_Top.tcl
