...
HD_PWD='D:/Study/Verilog/ComputerDesign/mymips28/mymips28.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MipsCPU_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MipsCPU_Top.tcl -notrace
